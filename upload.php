...
<form enctype="multipart/form-data" action="put.php" method="post" onsubmit="return AIM.submit(this, {'onStart' : startCallback, 'onComplete' : completeCallback});">
	<div><label>File:</label> <input type="file" name="uploaded" />
	<input type="hidden" id="bla" name="dctry" value="<?php echo $_SESSION['GEEK_LOGIN'];?>" />
