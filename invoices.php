...
<form enctype="multipart/form-data" action="iput.php" method="post" onsubmit="return AIM.submit(this, {'onStart' : startCallback, 'onComplete' : completeCallback});">
	<label>File:</label> <input type="file" name="uploaded" />
    <input type="hidden" id="bla" name="dctry" value="<?php echo $_SESSION['GEEK_LOGIN'];?>/invoices" />
